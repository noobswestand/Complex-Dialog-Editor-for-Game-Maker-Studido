...
for(var i=1;i<=string_length(str);i++){
    if string_char_at(str,i)=chr(13){
        ...
        if strPos0>strPos1{
            if i>strPos1 && i<=strPos0{
                ...
                draw_rectangle(xx+_xx,yy+_yy,xx+_xx+string_width(string_char_at(str,i)),yy+_yy+20,false)
                draw_set_color(c_white)
                draw_set_alpha(1)
                draw_text(xx+_xx,yy+_yy,string_char_at(str,i))
            }
    ...
    _xx+=string_width(string_char_at(str,i))
    }
}
