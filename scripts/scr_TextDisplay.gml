var str=argument0;//the string to drawxpos=argument1;//the starting x position of the text
var xpos=argument1;//the starting x position of the text
var ypos=argument2;// the starting y position of the text
